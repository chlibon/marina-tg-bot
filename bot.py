...
SYSTEM_PROMPT  = (
    ...
    "Отвечай кратко если вопрос простой, развёрнуто и с пунктами, если сложный. "
...
async def handle_photo(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        if any(kw in caption_lower for kw in ["прочитай", "текст", "ocr", "что написано", "читай", "распознай текст", "извлеки текст"]):
            prompt = "Извлеки и выведи весь текст с этого изображения дословно. Выводи только чистый текст без LaTeX, markdown, звёздочек и спецсимволов. Если текста нет — скажи об этом."
