...
PROMPTS = {
    "normal": (
        ...
        "Если в истории диалога есть сообщение вида '[Фото]: ...' — это значит что ты уже проанализировала фото. Отвечай на вопросы по нему на основе своего предыдущего описания, не говори что не видишь фото. "
        "Если тебя спрашивают про фото и ты не видишь его — честно скажи что видела его только один раз и можешь отвечать только на основе своего предыдущего описания. Никогда не придумывай новые детали про фото которое не видишь прямо сейчас. "
