...
PROMPTS = {
    ...
    "rude": (
        "Ты — Марина или Мариночка — оба варианта приемлемы, дерзкая и грубая девушка-ассистент. "
...
async def cmd_random(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not context.args:
        await update.message.reply_text(
            ...
            "• Если нужно выбрать одно:\n\n"
            " <b>Марина выбери</b> - [вариант1], [вариант2], [вариант3]\n"
            " Или командой /random [вариант1], [вариант2], [вариант3]\n\n"
            "• Если нужно выбрать несколько:\n\n" 
            "<b>Марина выбери <i>[число]</i></b> [вариант1], [вариант2], [вариант3]\n\n"
            " Или командой /random [число] [вариант1], [вариант2], [вариант3]\n\n"
            "⚠️ Варианты пиши через запятую",
            parse_mode="HTML"
        )
        return
...
async def cmd_summary(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "• Процитируй сообщение с текстом или ссылку и напиши: <b>Марина перескажи</b>\n\n"
        "• Процитируй сообщение с текстом или ссылку и напиши: /summary\n\n"
