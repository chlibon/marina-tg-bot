...
async def cmd_skills(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        ...
        "🎙 <b>Голосовые</b>\n"
        "• Преобразую все голосовые сообщения в текст\n"
        "• Начни голосовое с <b><i>«Марина»</i></b> и задай вопрос\n\n"

        "📖 <b>Пересказ</b>\n"
        "• <b><i>Марина перескажи</i></b> + цитата текста или ссылки\n"
        "• Или /summary + ссылка\n\n"
