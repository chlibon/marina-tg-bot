        ...
        enhanced = groq_client.chat.completions.create(
            ...
            messages=[{
                ...
                "content": (
                    ...
                    f"Запрос: '{prompt}'\n"
                    f"Важно: ты улучшаешь текстовый промпт для нейросети генерации изображений. "
                    f"Не описывай картинку и не добавляй ссылки — только улучшенный промпт на английском."
                )
            }],
            temperature=0.7,
            max_tokens=200,
